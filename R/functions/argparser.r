...
#------------------------------------------------------------------------------
  ...
  source( file.path( titan_fun_path, "argparser_buddy_event.r"), local=T)
  #.............................................................................. 
  # Buddy-check
  ...
  source( file.path( titan_fun_path, "argparser_obsrep.r"), local=T)
  #.............................................................................. 
  # read laf file
  source( file.path( titan_fun_path, "argparser_laf.r"), local=T)
  #.............................................................................. 
  # read dem file
  ...
  #.............................................................................. 
  # cool check
  source( file.path( titan_fun_path, "argparser_cool.r"), local=T)
  #.............................................................................. 
  # blacklist
  ...
  source( file.path( titan_fun_path, "argparser_radarout.r"), local=T)
  #.............................................................................. 
  # doit flags
  ...
  source( file.path( titan_fun_path, "argparser_fgt_det.r"), local=T)
  #.............................................................................. 
