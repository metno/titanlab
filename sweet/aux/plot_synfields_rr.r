...
if (argv$ffin_fields=="/home/cristianl/data/sweet/rr/synrr_l050000_n0100.nc") lab <- c("(d)","(e)","(f)")
if (argv$ffin_fields=="/home/cristianl/data/sweet/rr/synrr_l400000_n0100.nc") lab <- c("(g)","(h)","(i)")
r[]<-t(data[,,1])
