...
#  for t in 01 02 03 04 05; do
  for t in 06 07 08 09 10; do
    ...
    $sct --ffin_fields $ffin_fields --ffin_obs $ffin_obs --ffout $ffout --config_file $ffconf --tpos_score $tpos_score --tneg_score $tneg_score --pGE $pGE --thinobs_perc $thinobs_perc --boxcox_lambda $bxcx
